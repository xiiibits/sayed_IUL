    ...
    <div class="dashboard-container">
        <div class="welcome-section">
            ...
            <div style="margin-top: 30px;">
                ...
                <a href="edit_profile.php" class="login-btn" style="margin-left: 10px; text-decoration: none;"><i class="fas fa-edit"></i> Edit Profile</a>
            </div>
        </div>
        ...
        <div class="welcome-section">
            ...
            <div class="user-info">
                ...
                <div class="info-card">
                    ...
                    <p><strong>Session ID:</strong> <?php echo substr($_SESSION['session_id'], 0, 8) . '...'; ?></p>
                </div>
            </div>
        </div>
    </div>
